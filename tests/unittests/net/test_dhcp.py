...
class TestParseDHCPLeasesFile(CiTestCase):
    ...
    def test_parse_multiple_leases(self):
        ...
        self.assertEqual(
            ...
            IscDhclient.parse_dhcp_lease_file(lease_file),
        )

    def test_parse_multiple_leases_with_static_routes(self):
        """IscDhclient.parse_dhcp_lease_file returns a list of all leases
        within.
        """
        lease_file = self.tmp_path("leases")
        content = dedent(
            ...
            lease {
              ...
              option subnet-mask 255.255.255.0;
              option routers 192.168.2.1;
              option static-routes 10.240.0.1/32 0.0.0.0 0.0.0.0/0 10.240.0.1;
              renew 4 2017/07/27 18:02:30;
              expire 5 2017/07/28 07:08:15;
            }
            lease {
    ...
    def test_parse_multiple_leases_with_static_routes_and_ib(self):
        """IscDhclient.parse_dhcp_lease_file returns a list of all leases
        within.
        """
        lease_file = self.tmp_path("leases")
    ...
    def test_parse_multiple_leases_with_static_routes_and_ib_2(self):
        """IscDhclient.parse_dhcp_lease_file returns a list of all leases
        within.
        """
        lease_file = self.tmp_path("leases")
    ...
    @mock.patch("cloudinit.net.dhcp.networkd_load_leases")
    @mock.patch("cloudinit.net.dhcp.subp.subp")
